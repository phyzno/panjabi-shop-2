  ...
  try {
    ...
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        <h1 className="text-2xl font-bold mb-4">Account Temporarily Unavailable</h1>
        <p className="text-muted-foreground mb-8">We are experiencing issues connecting to the authentication service. Please try again later.</p>
        <Link href="/" className="bg-primary text-white px-6 py-2 rounded-lg">Back to Home</Link>
      </div>
    );
  }
}
