...
export function PanjabiCanvas({
  ...
  return (
    <div className="relative w-full h-full z-[999] lg:h-auto lg:max-w-[500px] lg:aspect-square mx-auto lg:bg-[#F5F0EA] lg:rounded-2xl lg:shadow-[0_8px_40px_rgba(0,0,0,0.12)] overflow-hidden group flex items-center justify-center">
      ...
      {!hideControls && (
        <div className="absolute bottom-28 left-0 right-0 lg:left-4 lg:right-4 flex flex-row justify-between items-center gap-1 text-[10px] lg:text-xs text-gray-500 bg-white/80 backdrop-blur-md px-3 lg:px-4 py-2 rounded-t-xl lg:rounded-xl shadow-sm z-20 border border-white/50 lg:border-gray-100">
